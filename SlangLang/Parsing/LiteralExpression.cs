...
namespace SlangLang.Parsing
{
    public sealed class LiteralExpression : ExpressionNode
    {
        ...
        public LiteralExpression(object val, LanguageToken token, TextLocation where, LiteralValueSpecifier spec = LiteralValueSpecifier.Default) : base(token, ExpressionNodeType.Literal, where)
        {
            value = val;
            valueSpecifier = spec;
        }
